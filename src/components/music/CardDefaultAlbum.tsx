...
const CardDefaultAlbum: React.FC<Album> = ({title, artistId, image}) => {
    ...
    return (
        <>
            <article className="relative group flex flex-col gap-2 w-40 lg:w-[200px] h-63 lg:h-70 p-3 bg-[#171717] rounded-[10px] hover:bg-[#282828]">
                <Image src={image} alt={title} width={200} height={200} className='rounded-[5px]'/>
...
export default CardDefaultAlbum
